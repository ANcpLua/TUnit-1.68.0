...
public class InternalsAccessTests
{
    ...
    //
    // Up to 1.68.0 an IDE also kept VendorSdk as a live project reference next to the publicized
    // copy, the project's own compilation won, and every IQuotaPolicy below was underlined with
    // CS0122 while the build stayed clean. Fixed in 1.68.17 — see DesignTimeReferenceTests.
    [Test]
