...
public sealed class TrailingArrayTests
{
    // Fixed in 1.65.68 (#6681): a foreign array (object[] from an untyped source) is converted element-wise
    // into a trailing array parameter instead of being boxed as its single element.
    [Test]
    [Batches]
    public async Task Trailing_array_parameter_receives_every_element(string label, int[] values)
    {
