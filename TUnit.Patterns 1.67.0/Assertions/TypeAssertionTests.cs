...
/// <summary>
/// 1.66.0: Assert.That(Type) returns a TypeValueAssertion, so assignability checks evaluate the represented type
/// (typeof(CardProvider)) instead of the Type object's own runtime type (RuntimeType), which made them fail before.
/// </summary>
