...
/// <summary>
/// Verified on 1.65.68: an assembly-level limiter is applied *instead of* a class-level one (the docs describe
/// Method > Class > Assembly precedence), so it belongs with the other assembly-wide policies.
/// </summary>
