...
namespace TUnit.Mocks_1._68._0;
...
public class RefStructEventTests
{
    ...
    // Fixed in 1.68.0: on 1.67.0 the generator cast ref struct event arguments to and from object, so
    // ISensor.Mock() did not even compile. Raise{EventName}() now dispatches them typed, without boxing.
    [Test]
